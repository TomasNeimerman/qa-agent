...
- Whether discovery is implemented as orchestrator-driven Glob/Grep/Read tool calls, a deterministic Node helper script, or a mix — see Open Questions below, this is a real unresolved tension between CONTEXT.md's "Established Patterns" framing and the project's own CLAUDE.md/STACK.md guidance, flagged for the planner to resolve explicitly.
