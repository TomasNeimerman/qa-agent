...
**Plans**: 4/4 plans executed (05-04 added by gap closure)

Plans:
**Wave 1**

- [x] 05-01-PLAN.md — Tracer: a validated test-cases document becomes a deterministic one-positivo-per-surface smoke set, dispatched through the unchanged Run protocol (REP-03, D-01–D-07)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 05-02-PLAN.md — Cross-project validation: discovery, generation, selection and a live smoke run against DATAX-web, dotax and franquix (PKG-02, D-08, D-09, D-10)
- [x] 05-03-PLAN.md — Tightened installation and MCP-setup docs, proven by a clean-directory rehearsal (PKG-03, D-11, D-12, D-13)
- [x] 05-04-PLAN.md — Gap closure (CR-01): the `--smoke` branch validates the whole document, forbidden-dispatch-flag scan included, before it selects anything (REP-03)
